...
sarveMasterCtrl.sarveMasterActiveDeactive = (req, res) => {
  ...
  SarveMasterModel.updateOne(
    query,
    { $set: { status: req.body.status } },
    function (err, sarveMaster) {
      if (err) {
            ...
            SarveMasterModel.update(
              ...
              function (err, sarveMaster) {
                if (err) {
                  ...
                  sarveMaster == undefined ||
                  (sarveMaster.matchedCount === 0 &&
                    sarveMaster.modifiedCount === 0)
                ) {
                  response.setError(AppCode.NotFound);
                } else {
