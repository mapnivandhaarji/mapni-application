...
//  save sarveMaster data : http://localhost:5001/v1/sarveMaster/sarveMasterCreate
router.route("/sarveMasterCreate").post(CONFIG.JWTTOKENALLOWACCESS, SarveMasterCtrl.sarveMasterCreate)

//Update sarveMaster data  : http://localhost:5001/v1/sarveMaster/sarveMasterUpdate
router.route("/sarveMasterUpdate").post(CONFIG.JWTTOKENALLOWACCESS, SarveMasterCtrl.sarveMasterUpdate);

// sarveMaster Details By Id data  : http://localhost:5001/v1/sarveMaster/sarveMasterDetailsById?_id=
router.route("/sarveMasterDetailsById").get(CONFIG.JWTTOKENALLOWACCESS, SarveMasterCtrl.sarveMasterDetailsById);

// sarveMaster List data  : http://localhost:5001/v1/sarveMaster/sarveMasterList
router.route("/sarveMasterList").get(CONFIG.JWTTOKENALLOWACCESS, SarveMasterCtrl.sarveMasterList);

// sarveMaster Active-Deactive data  : http://localhost:5001/v1/sarveMaster/sarveMasterActiveDeactive
...
// // Active sarveMaster List data  : http://localhost:5001/v1/sarveMaster/activeRoleList
// router.route("/activeRoleList").get(AdminAuthCtrl.activeRoleList);

//Get Active sarveMaster Data List API : http://localhost:5001/v1/sarveMaster/activeSarveMasterList
router.route("/activeSarveMasterList").get(CONFIG.JWTTOKENALLOWACCESS, SarveMasterCtrl.activeSarveMasterList);



// sarveMaster delete details: http://localhost:5001/v1/sarveMaster/deleteSarveMaster
