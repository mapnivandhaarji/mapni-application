...
class districtTalukaListModel extends ModelBase {
  constructor() {
    super(CONFIG.DB.MONGO.DB_NAME, "talukaList", {
      districtName: { type: String, allowNullEmpty: true },
...
module.exports = districtTalukaListModel;
